...
#torrent_kortv_ent, 54461
#torrent_movie_kor, 4264
# for i in range(54471,54461,-1):
#     tosarang(i,'torrent_kortv_ent')


# asia 4259,4250
# for i in range(4269,4259,-1):
#     tguri(i, 'asia')

# seq = getSeq('tosarang', 'torrent_movie_kor')
# tosarang(seq, 'torrent_movie_kor')
